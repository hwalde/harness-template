...
description: >-
  ...
  antwortet mit PASS oder NEEDS_WORK plus konkreten, behebbaren Findings. Optional mit Fokus
  (z. B. Sicherheit, Performance, Clean Code, Coding-Guidelines, Architektur) als
